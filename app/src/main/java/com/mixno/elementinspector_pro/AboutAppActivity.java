...
public class AboutAppActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        actionVK.setVisibility(View.GONE);
        ...
        actionTELEGRAM.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Data.openUrl(AboutAppActivity.this, "https://t.me/elinther");
                } catch (Exception e) {}
            }
        });
        actionINSTAGRAM.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Data.openUrl(AboutAppActivity.this, "https://instagram.com/elinther_orig");
                } catch (Exception e) {}
            }
        });
