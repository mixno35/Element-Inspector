package com.mixno.elementinspector_pro.code.request;
...
public class GET {
    ...
    public static void alert(final Context context, final WebEI web) {
        ...
        dialog.setTitle(String.format(context.getString(R.string.title_emulation_a_request), context.getString(R.string.title_get)));
        ...
        buttonGo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    web.loadUrl(editTextUrl.getText().toString() + "?" + result);
                } catch (Exception e) {
                    Toast.makeText(context, "Error send GET request: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                }
                dialog.dismiss();
            }
        });
