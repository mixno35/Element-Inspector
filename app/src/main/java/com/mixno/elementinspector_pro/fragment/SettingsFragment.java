package com.mixno.elementinspector_pro.fragment;
...
import com.mixno.elementinspector_pro.AboutAppActivity;
import com.mixno.elementinspector_pro.CacheWebViewActivity;
import com.mixno.elementinspector_pro.ClearDataActivity;
import com.mixno.elementinspector_pro.FeedbackActivity;
import com.mixno.elementinspector_pro.HistoryActivity;
import com.mixno.elementinspector_pro.MainActivity;
import com.mixno.elementinspector_pro.ProxySettingsActivity;
import com.mixno.elementinspector_pro.R;
import com.mixno.elementinspector_pro.SearchEngineOtherActivity;
...
//        Preference keyLocalhost = findPreference("keyLocalhost");
        ...
        Preference keyProxySettings = findPreference("keyProxySettings");
...
//        });
        ...
        keyProxySettings.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                getActivity().startActivity(new Intent(getActivity(), ProxySettingsActivity.class));
                return false;
            }
        });
