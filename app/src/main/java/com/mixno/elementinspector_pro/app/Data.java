...
public class Data {
    ...
    public static String PATH_HOME = Environment.getExternalStorageDirectory().getPath() + File.separator + ".ei";
    public static String PATH_HISTORY = Environment.getExternalStorageDirectory().getPath() + File.separator + ".ei" + File.separator + ".history";
    ...
    public static float reverseNum(String number) {
        if (number.equals("1,0")) {
            return ((float)0.0);
        } if (number.equals("0,9")) {
            return ((float)0.1);
        } if (number.equals("0,8")) {
            return ((float)0.2);
        } if (number.equals("0,7")) {
            return ((float)0.3);
        } if (number.equals("0,6")) {
            return ((float)0.4);
        } if (number.equals("0,5")) {
            return ((float)0.5);
        } if (number.equals("0,4")) {
            return ((float)0.6);
        } if (number.equals("0,3")) {
            return ((float)0.7);
        } if (number.equals("0,2")) {
            return ((float)0.8);
