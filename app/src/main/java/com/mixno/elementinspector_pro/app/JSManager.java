...
public class JSManager {
    ...
    public static String META_THEME_COLOR = "(function () { const metas = document.getElementsByTagName('meta'); for (let i = 0; i < metas.length; i++) { if (metas[i].getAttribute('name') === 'theme-color') { return window.Android.getThemeColorSite(metas[i].getAttribute('content')); } } return ''; })();";
